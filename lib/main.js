...
editor.vm = (function() {
  ...
  vm.init = function(kaavio) {
    ...
    var pvjsElementAndResetSource = kaavio.diagramComponent.vm.pvjsElementSource
    ...
    // This Observer only starts when this component is initialized. We want to get
    // the most recent pvjsElement or reset, so this is sending the latest click target id
    // back through the previous Observer.
    kaavio.diagramComponent.vm.clickTargetIdSource.onNext(
        kaavio.diagramComponent.vm.nonNullClickTargetId);
