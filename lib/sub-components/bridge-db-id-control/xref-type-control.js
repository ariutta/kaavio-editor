...
entityReferenceTypeControl.vm = (function() {
  ...
  vm.entityReferenceTypeIdToEntityTypeIdMappings = {
    ...
    // TODO the entity type id should be gpml:Unknown, but
    // Need to update gpml2pvjson converter before changing here.
    'gpml:UnknownReference': 'biopax:PhysicalEntity'
  };
