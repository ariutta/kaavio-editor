...
annotationTab.vm = (function() {
  ...
  vm.init = function(kaavio) {
    ...
    vm.updatePvjson = function(selectedEntityReference) {
      ...
      pvjsElement.type = typeMappingsEntityReferenceToEntity[entityReferenceTypeId];
    ...
    m('div.form-group.navbar-left', [
      m('div', {
        ...
        m.component(entityTypeControl, {
          ...
          onchange: function(updatedEntityType) {
            var pvjsElement = vm.pvjsElement;
            var oldEntityTypeId = pvjsElement.type;
            var updatedEntityTypeId = updatedEntityType.id;
