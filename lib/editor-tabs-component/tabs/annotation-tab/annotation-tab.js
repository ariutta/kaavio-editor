...
annotationTab.vm = (function() {
  ...
  vm.init = function(kaavio) {
    ...
    var bridgeDbIdControlChangeSource = vm.bridgeDbIdControlChangeSource = new Rx.Subject();
    ...
    var bridgeDbIdCompleteSource = bridgeDbIdControlChangeSource.debounce(700 /* ms */)
    ...
    vm.updateTextContent = function(pvjsElement, updatedTextContent) {
      ...
      vm.containerElement.querySelector('#text-for-' + pvjsElement.id)
        .querySelector('text').textContent = updatedTextContent;
    };
      ...
      m('div', {
        ...
        m.component(bridgeDbIdControl, {
          ...
          onchange: function(result) {
            vm.bridgeDbIdControlChangeSource.onNext(result);
          },
          style: {
            clear: 'both',
