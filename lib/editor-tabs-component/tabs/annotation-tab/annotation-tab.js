    ...
    m('div.navbar-left', [
      m.component(annotationTab.xrefSearch, {
        ...
        onchange: function(entityType) {
          ...
          vm.pvjsElement.type = entityTypeId;
          var entityReferenceTypeId = vm.entityTypeIdToEntityReferenceTypeIdMappings[entityTypeId];
          vm.entityReferenceTypeId(entityReferenceTypeId);
          if (_.isEmpty(vm.pvjsElement())) {
            vm.pvjsElement().type = entityReferenceTypeId;
          }
        },
    ...
    m('div.form-group.navbar-left', [
      m('div', {
        ...
        m('input', {
          ...
          oninput: m.withAttr('value', function(textContent) {
