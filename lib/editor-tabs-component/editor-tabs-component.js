...
editorTabsComponent.vm = (function() {
  ...
  vm.init = function(kaavio) {
    ...
    var parentHierarchy = vm.pvjsElementHierarchy = kaavio.editor.vm.pvjsElementHierarchy;

    vm.pvjsElementSource = parentHierarchy.mainSource;
    vm.resetSource = parentHierarchy.resetSource;
    ...
    vm.pvjsElementSource
      .subscribe(function(pvjsElement) {
        console.log('ke et pvjsElement48');
